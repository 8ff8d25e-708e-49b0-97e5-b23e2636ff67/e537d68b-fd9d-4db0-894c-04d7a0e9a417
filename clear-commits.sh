...
for branch in `ls .git/refs/heads`; do
    ...
    git filter-branch -f --env-filter '
        export GIT_AUTHOR_NAME="Unknown student"
        export GIT_AUTHOR_EMAIL="student@ox.ac.uk"
        export GIT_COMMITTER_NAME="Unknown student"
        export GIT_COMMITTER_EMAIL="student@ox.ac.uk"
    ' $branch
done
